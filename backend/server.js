...
const DEMO_PRODUCTS = [
  { _id:'p1', name:'MacBook Pro 16"', slug:'macbook-pro-16', price:279900, discount:10, finalPrice:249900, stock:15, brand:'Apple', category:{_id:'cat1',name:'Electronics'}, thumbnail:'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&q=80', images:['https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=600&q=80'], averageRating:4.9, numReviews:128, isFeatured:true, tags:['apple','laptop'], features:['M3 Pro chip','36GB RAM','1TB SSD','16" Retina'], description:'The most powerful MacBook Pro ever.' },
  { _id:'p2', name:'iPhone 15 Pro Max', slug:'iphone-15-pro-max', price:179900, discount:0, finalPrice:179900, stock:30, brand:'Apple', category:{_id:'cat1',name:'Electronics'}, thumbnail:'https://images.unsplash.com/photo-1632661674596-df8be070a5c5?w=600&q=80', images:['https://images.unsplash.com/photo-1632661674596-df8be070a5c5?w=600&q=80'], averageRating:4.8, numReviews:256, isFeatured:true, tags:['apple','iphone'], features:['A17 Pro chip','48MP camera','Titanium','USB-C'], description:'The most advanced iPhone ever.' },
  { _id:'p3', name:'Sony WH-1000XM5', slug:'sony-wh-1000xm5', price:34990, discount:15, finalPrice:29990, stock:45, brand:'Sony', category:{_id:'cat4',name:'Audio'}, thumbnail:'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&q=80', images:['https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&q=80'], averageRating:4.7, numReviews:89, isFeatured:true, tags:['sony','headphones'], features:['30hr battery','ANC','Multipoint'], description:'Best noise cancelling headphones.' },
  { _id:'p4', name:'Nike Air Jordan 1 Retro', slug:'nike-air-jordan-1-retro', price:15995, discount:0, finalPrice:15995, stock:60, brand:'Nike', category:{_id:'cat3',name:'Footwear'}, thumbnail:'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80', images:['https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80'], averageRating:4.9, numReviews:340, isFeatured:false, tags:['nike','jordan'], features:['Leather upper','Air-Sole unit'], description:'The shoe that started it all.' },
  { _id:'p5', name:'Apple Watch Ultra 2', slug:'apple-watch-ultra-2', price:89900, discount:0, finalPrice:89900, stock:20, brand:'Apple', category:{_id:'cat5',name:'Wearables'}, thumbnail:'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=600&q=80', images:['https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=600&q=80'], averageRating:4.8, numReviews:67, isFeatured:true, tags:['apple','watch'], features:['Titanium case','60hr battery'], description:'Most rugged Apple Watch ever.' },
  { _id:'p6', name:'Samsung Galaxy S24 Ultra', slug:'samsung-galaxy-s24-ultra', price:149999, discount:8, finalPrice:134999, stock:25, brand:'Samsung', category:{_id:'cat1',name:'Electronics'}, thumbnail:'https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=600&q=80', images:['https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=600&q=80'], averageRating:4.6, numReviews:112, isFeatured:false, tags:['samsung','galaxy'], features:['200MP camera','S Pen','Galaxy AI'], description:'Ultimate Android experience.' },
  { _id:'p7', name:'Adidas Ultraboost 23', slug:'adidas-ultraboost-23', price:19999, discount:20, finalPrice:15999, stock:80, brand:'Adidas', category:{_id:'cat3',name:'Footwear'}, thumbnail:'https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=600&q=80', images:['https://images.unsplash.com/photo-1608231387042-66d1773070a5?w=600&q=80'], averageRating:4.5, numReviews:198, isFeatured:false, tags:['adidas','running'], features:['BOOST midsole','Primeknit upper'], description:'Incredible energy return with every stride.' },
  { _id:'p8', name:'LV Neverfull MM', slug:'lv-neverfull-mm', price:230000, discount:0, finalPrice:230000, stock:8, brand:'Louis Vuitton', category:{_id:'cat6',name:'Accessories'}, thumbnail:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&q=80', images:['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&q=80'], averageRating:4.9, numReviews:44, isFeatured:true, tags:['lv','luxury','bag'], features:['Monogram canvas','Leather trim'], description:'Iconic spacious tote bag.' },
];
